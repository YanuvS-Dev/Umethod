...
![process: Scoring each gene for each cluster, then testing for significant markers](images/UmethodImage.png){width=30%}
...
# If the clusters are characters and not numbers,
...
```{r,plot-example,fig.width=14,fig.height=7,warning = FALSE, message = FALSE, echo=FALSE}
